...
import org.example.periodicity.accountsTasks.AccountsConnectionIntializerTask;
...
public class AccountsCommDb {
    ...
    //Connection connection=ConnectionIntializer.getConnection();
        try (Connection connection= AccountsConnectionIntializerTask.getConnection())
        {
    ...
    public static void transferAccountsBatchToMysql(Connection connection, @NotNull List<AccountModel> batchlist) throws SQLException {
